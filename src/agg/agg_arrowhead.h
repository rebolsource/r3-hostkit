...
namespace agg
{
    ...
    public:
		...
		void tail_head() { m_tail_head_flag = true; }
		void no_tail_head() { m_tail_head_flag = false; }
		void head_tail() { m_head_tail_flag = true; }
		void no_head_tail() { m_head_tail_flag = false; }
