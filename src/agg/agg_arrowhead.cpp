...
namespace agg
{
    ...
    arrowhead::arrowhead() :
        ...
        m_head_flag(false),
        m_tail_flag(false),
		m_tail_head_flag(false),
		m_head_tail_flag(false),
        m_curr_id(0),
        m_curr_coord(0)
    {
    }
    ...
    void arrowhead::rewind(unsigned path_id)
    {
        ...
        if(path_id == 1)
        {
			...
			if (m_head_tail_flag){
				...
				m_coord[2]  =  m_head_d1 - m_head_d4; m_coord[3]  =  m_head_d3;
				m_coord[4]  = -m_head_d2 - m_head_d4; m_coord[5]  =  m_head_d3;
				m_coord[6]  = -m_head_d2;             m_coord[7]  =  0.0;
				m_coord[8]  = -m_head_d2 - m_head_d4; m_coord[9]  = -m_head_d3;
				m_coord[10] =  m_head_d1 - m_head_d4; m_coord[11] = -m_head_d3;
