...
namespace agg
{
    ...
    private:
        pod_array<color_type> m_buf;
        pod_array<color_type> m_stack;
    };
    ...
    private:
        agg::pod_array<calculator_type> m_sum1;
        agg::pod_array<calculator_type> m_sum2;
        agg::pod_array<color_type>      m_buf;
    };
